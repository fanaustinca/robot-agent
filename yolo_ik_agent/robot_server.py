...
function runDetect(){
  ...
  fetch(url).then(r=>r.json()).then(data=>{
    ...
    document.getElementById('status').innerText=data.detections.length+' found';
...
# Original dashboard preserved at /dashboard
@app.route("/dashboard")
def dashboard_index():
    return """<!DOCTYPE html>
<html><head>
